...
export function ArsenalHero() {
  ...
  return (
    <div className="relative w-full  h-full rounded-3xl overflow-hidden">
      ...
      {/* Content Container */}
      <div className="relative h-full flex items-center justify-between px-4 py-4  lg:px-12 lg:py-10">
        {/* Left Content */}
        <div className="flex-1 max-w-full lg:max-w-3xl space-y-15 lg:space-y-6 ">
          <div className="space-y-4">
            <h1 className="lg:text-[64px]  text-[26px] text-white leading-tight font-semibold">Arsenal Tickets</h1>
            <p className="text-[15px] lg:text-lg text-white/90 leading-relaxed max-w-xl">
          ...
          {/* Trustpilot Rating */}
          <div className="flex items-center  text-sm lg:text-base gap-2 lg:gap-3 rounded-full px-0  lg:px-5 lg:py-3 w-fit  p-2">
            <span className="text-white md:text-sm lg:text-base font-semibold">Excellent</span>
            <div className="flex gap-1">
              {[...Array(5)].map((_, i) => (
            <div>
               <span className="bg-[#219653] p-[1px] lg:p-[2px] hidden lg:block">
             ...
             <span className="bg-[#219653] p-[1px] lg:p-[2px] block lg:hidden">
            ...
            <span className="text-white sm:text-xs md:text-sm  lg:text-base font-semibold">436 <span className="text-white/80">reviews on</span></span>
